...
public class TripleBlasterMissile extends Missile{

    public TripleBlasterMissile() {
        super();
    }

    public TripleBlasterMissile(int x, int y, int angle, float distanceMultiplier) {
        super();
        int speed = 300;
    ...
    public Missile newInstance(int x, int y, int angle, float distanceMultiplier) {
        return new TripleBlasterMissile(x,y, angle, distanceMultiplier);
    }
